...
<section class="w-full">
    ...
    <x-pages::settings.layout heading="Apariencia" subheading="Elige el tema de FarmaERP, igual que el interruptor del dashboard">
        <div class="grid gap-4 sm:grid-cols-3" role="radiogroup" aria-label="Tema de la aplicación">
            <button type="button" data-tema-card="claro" role="radio" aria-checked="false" class="tema-card rounded-2xl border p-4 text-left transition">
                ...
                <span class="mt-1 block text-sm text-slate-500">Fondo claro para el día.</span>
            </button>
