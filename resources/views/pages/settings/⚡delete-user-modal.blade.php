...
<flux:modal name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
    <form method="POST" wire:submit="deleteUser" class="space-y-6">
        <div>
            ...
            <flux:subheading>
                Una vez eliminada tu cuenta, todos sus recursos y datos se borrarán de forma permanente. Escribe tu contraseña para confirmar que quieres eliminar tu cuenta definitivamente.
            </flux:subheading>
        </div>
