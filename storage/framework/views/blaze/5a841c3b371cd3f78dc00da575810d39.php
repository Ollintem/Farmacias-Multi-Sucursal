<?php
if (!function_exists('__5a841c3b371cd3f78dc00da575810d39')):
function __5a841c3b371cd3f78dc00da575810d39($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
$invert ??= $attributes['invert'] ?? $__defaults['invert']; unset($attributes['invert']);
unset($__defaults);
?>
...
<ui-toast x-data x-on:toast-show.document="! $el.closest('ui-toast-group') && $el.showToast($event.detail)" popover="manual" position="<?php echo e($position); ?>" wire:ignore>
    <template>
        <div <?php echo e($attributes->only(['class'])->class('group/toast max-w-sm in-[ui-toast-group]:max-w-auto in-[ui-toast-group]:w-xs sm:in-[ui-toast-group]:w-sm')); ?> data-variant="" <?php echo e($invert ? 'data-invert' : ''); ?> data-flux-toast-dialog>
...
} endif; ?><?php /**PATH C:\Users\Spirit of Fire\Documents\Reportes_servicio\residencias\proyecto\programacion\Farmacias-Multi-Sucursal\vendor\livewire\flux\src/../stubs/resources/views/flux/toast/index.blade.php ENDPATH**/ ?>